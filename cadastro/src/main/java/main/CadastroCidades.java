...
import local.uninga.ads.cadastro.*;
	...
	public static void main(String[] args) {
		...
		while (sair == false) {
			...
			case 1:
				...
				cidade.setUf(JOptionPane.showInputDialog("Digite a UF"));
			...
			case 2:
				...
				cidade.setUf(JOptionPane.showInputDialog("Digite a UF a ser alterada"));
